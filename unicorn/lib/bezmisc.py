...
def bezierparameterize(value):
    # parametric bezier
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = value
    x0 = bx0
    y0 = by0
    cx = 3 * (bx1 - x0)
    bx = 3 * (bx2 - bx1) - cx
...
def linebezierintersect(value0, value1):
    # parametric line
    ((lx1, ly1), (lx2, ly2)) = value0
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = value1
    dd = lx1
    cc = lx2 - lx1
    bb = ly1
    aa = ly2 - ly1
...
def beziertatslope(value, value1):
    ((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)) = value
    (dy, dx) = value1
    ax, ay, bx, by, cx, cy, x0, y0 = bezierparameterize(((bx0, by0), (bx1, by1), (bx2, by2), (bx3, by3)))
